...
const Sidebar: React.FC<SidebarProps> = ({ openWarehouseConnection, openAppsConnection }) => {
  ...
  return (
    <div className="bg-black text-white w-64 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out flex flex-col">
      ...
      <nav className="flex-grow">
        ...
        <Link href="/sources" className="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-800 hover:text-white">
